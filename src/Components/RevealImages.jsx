...
function RevealImageListItem({ text, images }) {
  ...
  return (
    <div className="group relative h-fit w-fit overflow-visible py-8">
      <h1 className="text-5xl md:text-7xl font-black text-black transition-all duration-500 group-hover:opacity-40 font-montserrat">
        {text}
      </h1>
...
function RevealImageList() {
  const items = [
    ...
    },
    {
      ...
      images: [
        {
          src: "https://images.unsplash.com/photo-1575995872537-3793d29d972c?w=200&auto=format&fit=crop&q=60",
          alt: "Illustration Image 1",
        },
        {
          src: "https://images.unsplash.com/photo-1579762715118-a6f1d4b934f1?w=200&auto=format&fit=crop&q=60",
