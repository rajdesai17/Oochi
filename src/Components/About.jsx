    ...
    <div data-scroll data-scroll-section data-scroll-speed="-.2" className='w-full p-4 md:p-20 bg-yellow-400'>
      ...
      <div className='flex flex-col md:flex-row gap-8 pt-8 md:pt-20'>
        <div className='w-full md:w-1/2'>
          <h1 className='text-3xl md:text-6xl mb-6 md:mb-10'>Our Approach</h1>
          <button className='px-6 py-4 md:px-10 md:py-6 rounded-full bg-zinc-900 text-white flex items-center gap-3'>
            Read More
            <div className='w-2 h-2 bg-white rounded-full' />
          </button>
        </div>
        <div className='w-full md:w-1/2 h-[40vh] md:h-[70vh] bg-yellow-300 rounded-xl' />
      </div>
    </div>
  );
}
